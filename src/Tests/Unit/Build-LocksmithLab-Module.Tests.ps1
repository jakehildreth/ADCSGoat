...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module Build-LocksmithLab.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists
        It 'manifest should contain Build-LocksmithLab.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "Build-LocksmithLab.psm1"
        } #validPSM1
